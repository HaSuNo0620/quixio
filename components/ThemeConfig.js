...
const themeDefinitions = {
  light: {
    ...
    outerCellBackground: 'rgba(44, 123, 229, 0.09)',
    outerCellBorder: 'rgba(44, 123, 229, 0.18)',
  ...
  dark: {
    ...
    outerCellBackground: 'rgba(91, 156, 246, 0.08)',
    outerCellBorder: 'rgba(91, 156, 246, 0.2)',
